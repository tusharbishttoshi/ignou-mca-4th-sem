                  ...
                  <div class="col-lg-12">
                      ...
                      <nav aria-label="breadcrumb">
                          <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item"><a href="<?= site_url('events'); ?>">Events</a></li>
                  ...
                  <div class="col-lg-12">
                    ...
                    <section class="card">
                        <header class="card-header">
                            Update Events
                            <a class="btn btn-success float-right btn-sm" href="<?= site_url('events'); ?>">Back</a>
                        </header>
                        <div class="card-body">
                            <form class="form-submit" action="<?= site_url('events/update'); ?>" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="position" class="form-control" value="<?= $event->position; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Event date</label>
                                            <input type="text" name="event_date" class="form-control" id="last_date" value="<?= date('m/d/Y', strtotime($event->event_date)); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Event time</label>
                                            <input type="text" name="event_time" class="form-control" value="<?= date('h:i a', strtotime($event->event_date)); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="image1" class="form-control" value="<?= $event->image; ?>">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <img style="max-height:200; max-width:100%" src="<?= base_url('../assets/img/events/'.$event->image); ?>">
                                    </div>
