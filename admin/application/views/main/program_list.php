                  ...
                  <div class="col-lg-12">
                      ...
                      <nav aria-label="breadcrumb">
                          <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active"><a href="#">Programs</a></li>
                          </ol>
                      </nav>
                      <!--breadcrumbs end -->
                  </div>
                          ...
                          <div class="card-body">
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td><img src="<?= base_url('../assets/img/events/'.$bg->images); ?>" style="height:50; width:100px;"></td>
                                      ...
                                      <td style="width:9%;">
                                          ...
                                          <a href="<?= site_url('programs/edit/'.$bg->id); ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                                      </td>
                                  </tr>
                                  <?php } ?>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModal">Add new program</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="<?= site_url('programs/create_new'); ?>" class="form-submit" method="post" enctype="multipart/form-data">
