         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-4 texbocontact">
                  <h1 class="contactextban text-center"><span class="concont">Conflict Resolution </span> <span class="uscon">  </span></h1>
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-12 heading-event text-center">
                  <h1 class="own-font">Conflict Resolution- SOULS PEACE COMMISSION (SPC)</h1>
               </div>
               <div class="col-md-12">
                    <p>Preventing crisis or safely intervening requires professional verbal intervention skills. DFI works on resolving personal to international conflicts from a religious perspective. Its Conflict Resolution Docket engages in the following;  </p>
                   
                   <div class="pl-5">
                        <ul>
                            <li>
                               <p>1)	Establishment of quarterly city Imam’s breakfast program</p>
                            </li>
                            <li>
                               <p>2)	Establishment of quarterly Du’aats breakfast program</p>
                            </li>
                            <li>
                                <p>3)	Establishment of quarterly Ulamaa breakfast program</p>
                            </li>
                            <li>
                                <p>4)	Establishment of annual BETCOM convention</p>
                            </li>
                            <li>
                                <p>5)	Establishment of quarterly Ward open forum programs</p>
                            </li>
                            <li>
                                <p>6)	Organization of interfaith topical discussions  </p>
                            </li>
                        </ul>
                   </div>
                </div>
