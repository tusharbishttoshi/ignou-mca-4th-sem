         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-4 texbocontact">
                  <h1 class="contactextban text-center"><span class="concont">Science & research </span> <span class="uscon">  </span></h1>
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-12 heading-event text-center">
                  <h1 class="own-font">Science & research – Global Islamic Research Foundation (GIRF)</h1>
               </div>
               <div class="col-md-12">
                    <p><b>R</b>esearch is actually an act of studying something carefully and extensively in order to attain deep knowledge in the same. For being successful, research should be systematic, arranged, summarized and recorded properly.</p>
                   <p>Research has made ground breaking discoveries and development in the field of health, nutrition, food technology and medicine. These things have improved the life expectancy and health conditions of human race in all parts of the world and helped eradicate many diseases. Most Diseases that were untreatable are now history, as new and new inventions and research in the field of medicine have led to the advent of drugs that not only treat the once-incurable diseases, but also prevent them from recurring. There are diseases that affect the Soul and conventional experts cannot diagnose. GIRF focuses on cases of sickness/diseases that conventional doctors declared “healthy” but patients complain of diseases.  GIRF also focuses on herbals and their effects on the human body and all researches will be based on religion and science </p>
                   
                   <p>GIRF will engage in, among other activities, the following;   </p>
                   <div class="pl-5">
                        <ul>
                            <li>
                               <p>1)	Establishment of research Centres based on religious  & scientific investigations</p>
                            </li>
                            <li>
                               <p>2)	Delivery of topical lectures at home and abroad on various topical issues based on religion, philosophy and science</p>
                            </li>
                            <li>
                                <p>3)	Training of research students</p>
                            </li>
                        </ul>
                   </div>
                </div>
